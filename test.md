[Ecosystem] VS Code LSP Backend for Soroban Hints
Repo Avatar
dotandev/hintents
Implement a Language Server Protocol (LSP) backend in the ERST SDK. This will allow IDEs like VS Code to provide inline gas cost estimates, host function documentation, and potential execution hints directly in the developer's source code as they write it.
Files: internal/lsp/server.go [NEW], internal/visualizer/profiler.go
